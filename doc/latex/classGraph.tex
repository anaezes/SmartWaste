...
\begin{DoxyCompactItemize}
\item 
bool \hyperlink{classGraph_ac377db1f43140426d26810cd6ae6f3b6}{add\+Edge} (const T \&edge\+Id, const T \&sourc, const T \&dest, double w)
\end{DoxyCompactItemize}
...
\subsubsection[{\texorpdfstring{add\+Edge(const T \&edge\+Id, const T \&sourc, const T \&dest, double w)}{addEdge(const T &edgeId, const T &sourc, const T &dest, double w)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ bool {\bf Graph}$<$ T $>$\+::add\+Edge (
\begin{DoxyParamCaption}
...
\item[{double}]{w}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{classGraph_ac377db1f43140426d26810cd6ae6f3b6}{}\label{classGraph_ac377db1f43140426d26810cd6ae6f3b6}
...
\begin{center}
\leavevmode
\includegraphics[width=292pt]{classGraph_ac377db1f43140426d26810cd6ae6f3b6_cgraph}
\end{center}
\end{figure}
...
\index{Graph@{Graph}!add\+Edge@{add\+Edge}}
\index{add\+Edge@{add\+Edge}!Graph@{Graph}}
\subsubsection[{\texorpdfstring{add\+Edge(const T \&edge\+Id, const T \&sourc, const T \&dest, int w, bool is\+Undirected)}{addEdge(const T &edgeId, const T &sourc, const T &dest, int w, bool isUndirected)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ bool {\bf Graph}$<$ T $>$\+::add\+Edge (
\begin{DoxyParamCaption}
\item[{const T \&}]{edge\+Id, }
\item[{const T \&}]{sourc, }
\item[{const T \&}]{dest, }
...
\end{DoxyParamCaption}
)}\hypertarget{classGraph_a00dea5cb57b90bb1836040145c4dfb0a}{}\label{classGraph_a00dea5cb57b90bb1836040145c4dfb0a}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classGraph_a00dea5cb57b90bb1836040145c4dfb0a_cgraph}
\end{center}
\end{figure}
